...
{
    public void addition(int a,int b) {System.out.println("addition of " +a+ " and " +b+ (a+b) ); }
    public void subtraction(int a,int b){System.out.println("addition of " +a+ " and " +b+ (a-b) );}
    public void division(int a,int b){System.out.println("addition of " +a+ " and " +b+ (a/b) );}
    public void multiplication(int a,int b){System.out.println("addition of " +a+ " and " +b+ (a*b));}
